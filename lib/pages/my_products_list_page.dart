                        ...
                        onPressed:(){
                          ...
                          showDialog(context: context,
                              builder: (context)=>AlertDialog(
                                ...
                                actions: [TextButton(onPressed: (){myProductController.deleteMyProduct(product);} , child: Text('YES',style: TextStyle(color: Colors.red),)),
                                  TextButton(onPressed:  (){}, child: Text('NO',style: TextStyle(color: Colors.deepPurple),))
                                ],
                              )) ;
